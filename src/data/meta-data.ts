...
export const pageMetadataData = {
  easyPayment: {
    ...
    description:
      'Easy Floors makes it easy to pay! Split your payment into 4 with Tabby or Tamara. no interest, no fees. Shop with Visa, Mastercard, Apple Pay & Google Pay.',
