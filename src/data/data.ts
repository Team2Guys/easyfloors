...
export const emirateCityMap: Record<string, { value: string; label: string }[]> = {
  "Abu Dhabi": [
    ...
    { value: "Al Ain", label: "Al Ain" },
    { value: "Madinat Zayed", label: "Madinat Zayed" },
    { value: "Al Dhannah", label: "Al Dhannah" },
    ...
    { value: "Sweihan", label: "Sweihan" },
    { value: "Al Mirfa", label: "Al Mirfa" },
    { value: "Al Yahar", label: "Al Yahar" },
    { value: "Al Ajban", label: "Al Ajban" },
    { value: "Al Aryam", label: "Al Aryam" },
    { value: "Abu al Abyad", label: "Abu al Abyad" },
    { value: "Al Faqa", label: "Al Faqa" },
    { value: "Al Shuwaib", label: "Al Shuwaib" },
    { value: "Habshan", label: "Habshan" },
    { value: "Marawah", label: "Marawah" },
    { value: "Muzayri‘", label: "Muzayri‘" },
    { value: "Nahil", label: "Nahil" },
  ...
  "Dubai": [
    ...
    { value: "Al Lisaili", label: "Al Lisaili" },
    { value: "Al Faqa", label: "Al Faqa" },
    { value: "Lahbab", label: "Lahbab" },
