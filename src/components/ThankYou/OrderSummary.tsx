                                ...
                                <div className="flex items-center justify-between border-b gap-5 pb-4 mb-4">
                                    <div className="flex items-center md:gap-5 gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="md:text-sm text-gray-600 text-12">{accessoryflag ? "Total Required" : "No. Of Boxes"}: {item.requiredBoxes}{accessoryflag ? "" : ` (${item.squareMeter}  SQM)`}</p>
                                            <p className="md:text-sm text-gray-600 text-12">{accessoryflag ? "Piece Price" : "Box Price"}: <span className="font-currency text-15 font-normal"></span>{item.pricePerBox}</p>
