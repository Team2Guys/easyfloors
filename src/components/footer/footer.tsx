        ...
        <footer className="bg-gray-100 text-gray-700 pt-10 mt-20 px-0 mx-0 relative">
            <Container className=" mx-auto grid sm:grid-cols-4 lg:grid-cols-7 md:grid-cols-4 gap-4 2xl:gap-5 font-inter font-light" >
                ...
                <div className="flex flex-col space-y-3 fixed right-4 bottom-10 md:right-16  z-20">
                    ...
                    <Link href={`${process.env.NEXT_PUBLIC_WHATSAPP}`} aria-label="WhatsApp +971505974385" target='_blank' className="bg-[#25D366] text-white rounded-full shadow-lg flex items-center justify-center w-12 h-12">
                        <FaWhatsapp size={35} />
                    </Link>
                </div>
            </Container>
