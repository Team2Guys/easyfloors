...
const SubCategory = () => {
  return (
    <div className="space-y-4 font-inter">
      ...
      <div className="flex justify-between items-center bg-[#F2F4F5] p-3 rounded-md w-full">
        <div className="flex items-center gap-3">
          <span className="text-[#191C1F] text-14">Active Filters:</span>
          <div className="flex items-center  px-3 py-1  text-[#191C1F] text-14">
            Polar Herringbone SPC - American Walnut
            <FiX className="ml-2 text-gray-500 cursor-pointer hover:text-red-500" />
          </div>
        </div>
        <p className="text-[#191C1F] text-14">12 <span className="text-[#5F6C72]">Results found</span></p>
      </div>
    </div>
  );
};
