            ...
            <div className="md:p-4 md:text-center font-inter font-light">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start lg:items-center justify-between py-2 gap-2 md:gap-4 w-full">
                    ...
                    <div className="w-full md:text-right">
                        <Link
                            href="#"
                            className="text-black px-3 md:px-4 py-1.5 md:py-2 font-semibold text-[10px] md:text-[10px] lg:text-sm border border-primary hover:text-white hover:bg-primary transition whitespace-nowrap"
                        >
                            Shop Now
                        </Link>
