        ...
        <div className="max-w-screen-sm mx-auto px-2 py-5 xs:p-5 sm:p-10 shadow-[0px_3px_6px_#00000029] rounded-md h-fit">
          ...
          <Tabs value={activeTab} onValueChange={handleTabChange}>
            <TabsList className=" w-full text-center space-x-4  flex justify-center items-center">
              <TabsTrigger
                className={`text-16 md:text-2xl font-bold ${activeTab === 'Admin' ? 'text-primary' : 'text-gray-300'}`}
                value="Admin"
              >
                <FaRegUser />
                Admin
              ...
              <TabsTrigger
                className={`text-16 md:text-2xl font-bold ${activeTab === 'Super-Admin' ? 'text-primary' : 'text-gray-300'
                  }`}
                value="Super-Admin"
              >
                <FaRegUser />
