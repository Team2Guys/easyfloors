    ...
    <div className="relative w-full pt-3">
          ...
          {slug ? (
            <>
              {subcategory ? (
                ...
                <span className="text-blackfont-inter text-[8px] sm:text-12 md:text-14 font-bold">
                  {slug}
                </span>
              )}
              {subcategory ? (
      ...
      {image && (
        <div className="relative mt-2">
          <Image className={`object-fill w-full  sm:h-[200px] xl:h-[332px] ${imageClass}`} width={1400} height={400} src={image} alt={altText || title || "breadcrumb-image"} />
         {!isImagetext  && 
