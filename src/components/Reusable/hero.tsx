      ...
      {items.map((item, index) => (
        ...
        >
          ...
          <div className="bg-background">
            <div className="absolute top-[6%] sm:top-[20%] lg:top-[14%] bg-background left-4 sm:left-0 opacity-90 xs:opacity-95 p-2 sm:p-6 md:p-8 w-[52%] sm:w-[270px] md:w-[300px] lg:w-[400px] xl:w-[500px] shadow-md">
          ...
          <div className="absolute bottom-4 sm:bottom-5 right-3 sm:right-5 xl:right-14 bg-background opacity-90 xs:opacity-95 p-1 sm:p-4 md:p-5 shadow-md w-[170px] sm:h-auto sm:w-[180px] md:w-[220px] lg:w-[314px] sm:space-y-1 xl:space-y-2 justify-start text-start">
            ...
            >
              ...
              <div className=" flex justify-start items-center gap-2 mt-1 lg:mt-3 ">
                <span className='font-inter text-xs lg:text-xl sm:font-semibold font-normal'>Starting From <span className='font-currency font-normal text-[16px] lg:text-[25px]'></span> 49/m²</span>
