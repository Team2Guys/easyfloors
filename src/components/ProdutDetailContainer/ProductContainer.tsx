  ...
  return (
    <Container className={`flex flex-wrap lg:flex-nowrap gap-5 w-full mt-10 border-b pb-5 2xl:gap-20 ${className}`}>
      ...
      <div className="w-full 2xl:w-[40%] lg:w-[45%] mb-2 space-y-3 xl:space-y-4">
        ...
        <div className="flex text-15 sm:text-19 gap-1 items-center">
        ...
        <div className="flex w-full gap-1 items-center sm:gap-3">
          <button className="flex justify-center items-center  bg-primary text-12 text-white w-7/12 2xl:text-22 font-inter gap-1 max-sm:h-[40px] px-2 py-2 sm:py-3 sm:text-16"   onClick={() =>
            handleAddToStorage(
              productData,
              totalPrice,
              pricePerBox,
          ...
          >
            ...
            <p className="text-11 sm:text-14 xl:text-20">Order Now <strong><em>Free</em></strong> Sample</p>
          </button>
          <button
            onClick={() =>
              handleAddToStorage(
            ...
            className="flex bg-black justify-center text-11 text-white w-5/12 2xl:text-22 font-inter gap-2 items-center max-sm:h-[40px] px-2 py-2 sm:py-3 sm:text-16 sm:text-14 xl:text-16"
          >
