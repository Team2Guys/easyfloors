...
const ProductCard = () => {
  ...
  return (
    ...
    <div key={index} className="flex flex-col md:grid md:grid-cols-[2fr_1fr_1fr_1fr_2fr] lg:grid-cols-[3fr_2fr_1fr_1fr_1fr] 2xl:grid-cols-[3fr_1fr_1fr_1fr_2fr] md:gap-10 items-center  border-b md:border-t md:border-b border-gray-300  py-4 md:p-4">
      {/* Product Info */}
