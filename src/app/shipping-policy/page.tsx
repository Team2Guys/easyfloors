...
const Shipping = () => {
  return (
    <Container className="pt-5 md:pt-20 pb-20 space-y-4">
      ...
      <h2 className=" text-20 sm:text-28 font-semibold font-inter">Express Shipping- Next-day delivery</h2>
      <div className='space-y-2'>
      <h2 className=" text-18 sm:text-24 font-semibold font-inter">Shipping Fee:</h2>
      <ul className='list-disc px-6'>
        <li>All Emirates- <span className="font-currency font-normal text-18"></span> 150</li>
        <li>Free shipping for all orders above <span className="font-currency font-normal text-18"></span> 1000</li>
      </ul>
      ...
      <h2 className=" text-20 sm:text-28 font-semibold font-inter">Standard Shipping- Within 2-3 working days</h2>
      <div className='space-y-2'>
      <h2 className=" text-18 sm:text-24 font-semibold font-inter">Shipping Fee: <span className='font-normal'>Free for all Emirates</span></h2>
      ...
      <div className='space-y-2'>
      <h2 className="text-20 sm:text-28 font-semibold font-inter">Self Collect: Mon-Sat (9 am-6 pm)</h2>
      <p className=" text-18 sm:text-24 font-semibold font-inter">Location: <Link href="https://maps.app.goo.gl/VoKEfBJLA2y9fySt5" className='font-normal underline hover:text-primary'>Agsons, J1 Warehouses, Jebel Ali Industrial – Dubai</Link></p>
      </div>
      <h2 className=" text-20 sm:text-28 font-semibold font-inter">CASH ON DELIVERY: NOT AVAILABLE</h2>
    </Container>
  );
};
